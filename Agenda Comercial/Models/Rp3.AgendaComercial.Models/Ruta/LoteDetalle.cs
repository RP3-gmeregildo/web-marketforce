...
{
    [Table("tbLoteDetalle", Schema = "rut")]
    public class LoteDetalle : Rp3.Data.Entity.EntityBase, IUbicacion
    {
        public override string Key
        {
            get
            {
                return string.Format("{0}-{1}-{2}", this.IdLote, this.IdCliente, this.IdClienteDireccion);
            }
        }
