...
{
    [Table("tbCanal", Schema = "gen")]
    public class Canal : Rp3.Data.Entity.EntityBase
    {
        public override string Key
        {
            get
            {
                if (this.IdCanal == 0) return " ";
                return this.IdCanal.ToString();
            }
        }
        ...
        public void AsignarId()
        {
            ...
            this.IdCanal = service.Canales.GetMaxValue<int>(p => p.IdCanal, 0) + 1;
        }
    }
}
